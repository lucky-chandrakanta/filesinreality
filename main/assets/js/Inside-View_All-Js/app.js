...
var ShareBox = SingleView.extend({
  ...
  initialize: function() {
    ...
    html +='<div class="ui-share-options">';
      html +='<a title="Facebook" class="ui-icon show-hint"><i class="fab fa-facebook-square text-primary"></i></a>';
      html +='<a title="Twitter" class="ui-icon show-hint"><i class="fab fa-twitter-square text-info"></i></a>';
      html +='<a title="Google+" class="ui-icon show-hint"><i class="fab fa-google-plus-square text-danger"></i></a>';
      html +='<a title="Linkedin" class="ui-icon show-hint"><i class="fab fa-linkedin text-primary"></i></a>';
      html +='<a title="Email" class="ui-icon show-hint"><i class="fa fa-envelope text-warning"></i></a>';
    html +='</div>';
